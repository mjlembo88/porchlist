...
import { placeOrder } from "@/lib/stands/owner";
import { addReview, getStandBundle } from "@/lib/stands/server";
...
export function StandDetail({
  stand, onAskOwner, initialItems, initialSpecials, initialReviews, compact = false,
}: {
  stand: FarmStand;
  onAskOwner?: () => void;
